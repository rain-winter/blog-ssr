/*
  ...
  - You are about to alter the column `credential` on the `userauth` table. The data in that column could be lost. The data in that column will be cast from `VarChar(191)` to `Int`.
...
-- AlterTable
ALTER TABLE `userauth` MODIFY `credential` INTEGER NOT NULL;
